import type { ActivityLevel, Goal } from '@fittrack/core';
...
const GOAL_DELTA: Record<Goal, number> = {
  ...
  ai_coach: 0,
  // Transformation Challenge sets its own phase-based step target directly on
  // FitnessProfile.stepTarget; this is only the fallback until it does.
  challenge: 0,
};
